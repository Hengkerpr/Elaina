...
let wibh = moment.tz('Asia/Jakarta').format('HH')
    ...
    let wibs = moment.tz('Asia/Tuban').format('ss')
...
/*============== PAYMENT ==============*/
global.pdana = '0895801290205' //Nomor Danamu
global.ppulsa = '0895801290205' //Nomor SimCard Yang Kamu Pake
global.psaweria = 'https://saweria.com/XiaoYan021' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '6285745453217' //Nomor Bot
global.nomorown = '62895801290205' //Nomor Owner
global.namebot = 'Makros Md' //Nama Bot
global.nameown = 'Makros - Hengker' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['62895801290205', '❦ 𝚇 𝚒 𝚊 𝚘 - 𝚈𝚊𝚗? 🎐', true] //Ganti jd nomormu sama Namamu
